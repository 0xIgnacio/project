<template>
  <div id="app" class="relative">
    <div
      class="absolute top-0 bottom-0 left-0 right-0 pointer-events-none opacity-5"
      style="background: url('./dildos.jpg') no-repeat; background-size: cover"
    ></div>

    <div class="flex flex-col items-center justify-center w-full h-full">
      <div
        class="w-4/12 h-auto py-6 mb-5 shadow-xl rounded-xl"
        style="
      ...
      <div
        class="w-4/12 h-auto py-6 shadow-xl rounded-xl"
        style="
      ...
      >
        <div v-if="allowance">
          ...
          <input
            v-model="saleCode"
            type="text"
            class="w-8/12 h-12 mt-2 rounded-xl form-input"
          />
        ...
        <div
          v-bind:class="{ 'pointer-events-none opacity-40': !allowance }"
          class="flex w-full h-20 px-2"
        >
        ...
        <div class="w-full h-20 px-4 mt-6">
          ...
          <button
            v-else
            v-on:click="setAllowance(0)"
            class="w-full h-full btnDisabled"
          >
            Disable Contract
          </button>
        </div>
